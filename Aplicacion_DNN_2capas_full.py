...
def two_layer_model(X, YS, layers_dims, learning_rate = 0.0075, num_iterations = 3000, print_cost=False):
    ...
    for i in range(0, num_iterations):  #for i in range(0, num_iterations):
        ...
        A2, cache1 = linear_activation_forward(X, W1, b2, activation='relu')
        A3, cache2 = linear_activation_forward(A2, W2, b3, activation='sigmoid')
        ...
        dA3 = - (np.divide(YS, A3) - np.divide(1 - YS, 1 - A3))
        
        # Backward propagation. Inputs: "dA2, cache2, cache1". Outputs: "dA1, dW2, db2; also dA0 (not used), dW1, db1".
        
        ### Haga su código acá ###  (≈ 2 lines of code)
        
        dA2, dW2, db3 = linear_activation_backward(dA3, cache2, activation='sigmoid')
        dA1, dW1, db2 = linear_activation_backward(dA2, cache1, activation='relu')
